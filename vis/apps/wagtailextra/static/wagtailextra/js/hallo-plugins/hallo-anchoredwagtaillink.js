...
(function() {
  (function($) {
    return $.widget("IKS.anchoredwagtaillink", {
      options: {
        uuid: '',
        editable: null
      },
        ...
        return button.on("click", function(event) {
          ...
          if (enclosingLink) {
            ...
            if (lastSelection.collapsed) {
              url = window.chooserUrls.anchoredPageChooser + '?allow_external_link=true&allow_email_link=true&prompt_for_link_text=true';
            } else {
              url = window.chooserUrls.anchoredPageChooser + '?allow_external_link=true&allow_email_link=true';
            }
              ...
              responses: {
                pageChosen: function(pageData) {
                  ...
                  if (pageData.id) {
                    ...
                    a.setAttribute('data-anchor', pageData.anchor);
                  }
